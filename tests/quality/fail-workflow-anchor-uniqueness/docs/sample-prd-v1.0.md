# Workflow Anchor Failure: Product Requirements v1.0
...
**Flow: Create example**
1. User submits memory. `POST /api/v1/example`
2. User submits memory. `POST /api/v1/example`

## 8. Resolved Decisions
1. Example creation uses one endpoint.
